...
const FULL_TOOLS = [
  ...
  { type: 'function', function: { name: 'write_workspace_notes', description: 'Write workspace notes.', parameters: { type: 'object', properties: { content: { type: 'string' } }, required: ['content'] } } },
  ...
  { type: 'function', function: { name: 'create_or_edit_file', description: 'Create or overwrite file with content.', parameters: { type: 'object', properties: { filepath: { type: 'string' }, content: { type: 'string' } }, required: ['filepath', 'content'] } } },
