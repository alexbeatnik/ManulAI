...
- `gemma4:latest` (8B thinking model) works via the same text-tool fallback. It performs comparably to `llama3.1:8b` across the full regression suite.
